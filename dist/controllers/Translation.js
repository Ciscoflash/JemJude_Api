...
exports.CreateTranslationRequest = exports.upload = void 0;
...
const CreateTranslationRequest = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        const data = req.body;
        ...
        const TranscriptionData = Object.assign(Object.assign({}, data), { file }); // these is to combine the value of data and filename
        const Transcription = yield (0, Translation_1.CreateTranscription)(TranscriptionData);
        if (Transcription) {
            (0, resend_1.default)({
...
exports.CreateTranslationRequest = CreateTranslationRequest;
